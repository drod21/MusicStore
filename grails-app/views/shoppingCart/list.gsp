			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="total" title="${message(code: 'shoppingCart.total.label', default: 'Total')}" />
				...
				<g:each in="${shoppingCartInstanceList}" status="i" var="shoppingCartInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${shoppingCartInstance.id}">${fieldValue(bean: shoppingCartInstance, field: "total")}</g:link></td>
