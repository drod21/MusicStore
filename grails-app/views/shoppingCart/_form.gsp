...
<div class="fieldcontain ${hasErrors(bean: shoppingCartInstance, field: 'total', 'error')} required">
	<label for="total">
		<g:message code="shoppingCart.total.label" default="Total" />
		<span class="required-indicator">*</span>
	</label>
	<g:field name="total" value="${fieldValue(bean: shoppingCartInstance, field: 'total')}" required=""/>
</div>
