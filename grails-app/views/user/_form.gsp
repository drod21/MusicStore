...
<div class="fieldcontain ${hasErrors(bean: userInstance, field: 'purchasedSongs', 'error')} ">
	...
	<g:select name="purchasedSongs" from="${testapp.Song.list()}" multiple="multiple" optionKey="id" size="5" value="${userInstance?.purchasedSongs*.id}" class="many-to-many"/>
</div>
